...
mod tests {
    ...
    fn http_csv_export_with_special_characters() {
        let http = Http {
            ...
            resp_port: 443,
            proto: 6,
            start_time: Timestamp::from_nanosecond(1_000_000_000_000_000_000)
                .expect("valid timestamp"), // 1 second in nanoseconds
            end_time: Timestamp::from_nanosecond(1_000_000_000_000_000_000)
                .expect("valid timestamp"), // 1 second in nanoseconds
            duration: 0,
            orig_pkts: 1,
            resp_pkts: 1,
